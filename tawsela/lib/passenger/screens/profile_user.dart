...
class _profileUser extends State<ProfileUser> {
  ...
  Widget build(BuildContext context) {
    ...
    var name =
        "${userValue.containsKey("firstName") ? userValue["firstName"] : ""} ${userValue.containsKey("lastName") ? userValue["lastName"] : ""}";
    var image = userValue.containsKey("image") ? userValue["image"] : "";
    var type = userValue.containsKey("type") ? userValue["type"] : "";
    print("AAAAAAAAAAAAAAAAAAA $userValue");
    return Scaffold(
                ...
                onTap: () {
                  ...
                  if (type == "userDriver") {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (c) => MainDriver()));
                  } else {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (c) => Get_driver_data()));
                  }
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(context,
                      MaterialPageRoute(builder: (c) => PhoneScreen()));
                },
                child: Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(45),
